(function($) {
    ...
    if ($('.timer').length) {
        ...
        $('.cs-countdown').countdown('').on('update.countdown', function(event) {
            var $this = $(this).html(event.strftime('<div class="count-col"><span>%D</span><h6>days</h6></div> <div class="count-col"><span>%H</span><h6>H</h6></div> <div class="count-col"><span>%M</span><h6>M</h6></div> <div class="count-col"><span>%S</span><h6>S</h6></div>'));
        });
    }
