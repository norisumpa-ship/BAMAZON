! function(o) {
    ...
    o(document).ready(function() {
        ...
        jQuery(window).on("scroll", function() {
            50 < jQuery(this).scrollTop() ? jQuery(".scroll-to-top").addClass("scroll-top-active") : jQuery(".scroll-to-top").removeClass("scroll-top-active")
